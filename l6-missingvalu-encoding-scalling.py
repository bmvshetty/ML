...
print("contents of one hot encoder after transformation on housing datasets ocean proximity attribute\n")
print(housing_cat_1Hot.toarray())
print("\ncategories of onhotencoder:\n")
print(cat_encoder.categories_)

# standard scalar - converting all the columns to standard scalar 
